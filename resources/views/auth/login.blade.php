...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sign In | {{ env('APP_NAME_SCM') }}</title>
                                ...
                                <div class="col-lg-6">
                                  <div class="p-lg-5 p-4">
                                      <div>
                                          ...
                                          <p class="text-muted">Sign in to continue to SCM.</p>
                                      </div>
                                          ...
                                          <form action="{{ route('login') }}" class="row g-3 needs-validation" novalidate method="POST">
                                            @csrf
                                              <div class="mb-3">
                                                  ...
                                                  <input type="text" class="form-control" id="username" placeholder="Enter username" required autofocus name="username">
                                              </div>
