                                        ...
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a onclick="return confirmation('Apakah anda ingin menghapus ini?', 'Hapus','pemesanan/delete/{{ $item->pemesanan_id }}')"
...
<div class="modal fade" id="editModal" tabindex="-1"> 
    <div class="modal-dialog">
      <form action="{{ url('pemesanan/update') }}" method="post">
        @csrf
          <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body">
                  <div id="tampildataPemesanan"></div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary">Simpan</button>
...
<div class="modal fade" id="detailModal" tabindex="-1"> 
    <div class="modal-dialog">
      <form action="{{ url('pemesanan/update_detail') }}" method="post">
        @csrf
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="editModalLabel">Edit Data</h5>
              ...
              <div class="modal-body">
                  <div id="tampildetailPemesanan"></div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              </div>
...
<script>
    function edit(id){
        $.ajax({ 
            ...
            success:function(tampil){
                $('#tampildataPemesanan').html(tampil);
    ...
    function detail(id){
        $.ajax({ 
            type : 'get',
            url : "{{ url('pemesanan/detail')}}/"+id,
            // data:{'id':id}, 
            success:function(tampil){
                $('#tampildetailPemesanan').html(tampil);
