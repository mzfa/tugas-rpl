                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    <thead class="table-light">
                                        <tr>
                                            <th class="sort" data-sort="customer_nama">Nama Supplier</th>
                                            <th class="sort" data-sort="customer_nama">Tanggal PKS</th>
                                    ...
                                    <tbody class="list form-check-all">
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td class="customer_name">{{ $item->tgl_awal }} s/d {{ $item->tgl_akhir }}</td>
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <div class="edit">
                                                            <button class="btn btn-sm btn-success edit-item-btn" onclick="return edit({{ $item->supplier_id }})">Edit</button>
                                                        </div>
                                                        <div class="remove">
                                                            <a class="btn btn-sm btn-danger remove-item-btn" onclick="return confirm('Apakah anda yakin ini dihapus?')" href="{{ url('Supplier/delete/' . $item->supplier_id) }}">Remove</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
