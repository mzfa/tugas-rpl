...
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body table-responsive">
                            <h5 class="card-title">Jenis Pekerjaan <button type="button" class="btn btn-primary"
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a onclick="return edit({{ $item->jenis_pekerjaan_id }})"
                                                    class="btn text-white btn-warning"><i class="bi bi-pen"></i></a>
                                                <a onclick="return confirm('Apakah anda yakin ini akan di hapus?')"
                                                    href="{{ url('jenis_pekerjaan/delete/' . Crypt::encrypt($item->jenis_pekerjaan_id)) }}"
    ...
    <div class="modal fade" id="basicModal" tabindex="-1">
        <div class="modal-dialog">
            <form action="{{ url('jenis_pekerjaan/store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama_jenis_pekerjaan" name="nama_jenis_pekerjaan"
                                required>
                        </div>
                        <div class="mb-3">
    ...
    <div class="modal fade" id="editModal" tabindex="-1">
        <div class="modal-dialog">
            <form action="{{ url('jenis_pekerjaan/update') }}" method="post">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
...
@section('scripts')
    <script>
        function edit(id) {
            ...
            $.ajax({
                type: 'get',
                url: "{{ url('jenis_pekerjaan/edit') }}/" + id,
                // data:{'id':id}, 
