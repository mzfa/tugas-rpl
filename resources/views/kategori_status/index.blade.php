                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('Apakah anda yakin ini akan di hapus?')"
                                                    href="{{ url('kategori_status/delete/' . Crypt::encrypt($item->kategori_status_id)) }}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama_kategori_status" name="nama_kategori_status"
                                required>
                        </div>
                        <div class="mb-3">
