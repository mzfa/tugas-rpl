                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs d-flex" id="myTabjustified" role="tablist">
                            ...
                            <li class="nav-item flex-fill" role="presentation">
                                <button class="nav-link w-100" id="contact-tab" data-bs-toggle="tab"
                                    ...
                                    aria-controls="contact" aria-selected="false" tabindex="-1"><h2>Uraian Gambar Kerja</h2></button>
                            </li>
                        </ul>
                        <div class="tab-content pt-2" id="myTabjustifiedContent">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="tambah_dokumen_proses" style="display: none">
                                            <form action="{{ url('gambar_kerja/dokumen_proses_store') }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="card">
                                        ...
                                        <div id="editDokumenProses" style="display: none">
                                            <form action="{{ url('gambar_kerja/dokumen_proses_update') }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="card">
                                                    <div class="card-header">
                                            ...
                                            <tbody>
                                                @foreach ($data_dokumen_proses as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->username }}</td>
                                                        <td>
                                                            <a onclick="return edit({{ $item->dokumen_proses_gambar_kerja_id }})"
                                                                class="btn text-white btn-warning"><i class="bi bi-pen"></i></a>
                                                            <a onclick="return confirm('Apakah anda yakin ini akan di hapus?')" href="{{ url('gambar_kerja/delete_proses_store/' . Crypt::encrypt($item->dokumen_proses_gambar_kerja_id)) }}" class="btn text-white btn-danger"><i class="bi bi-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                            ...
                            <div class="tab-pane fade" id="profile-justified" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="card mt-3">
                                    <div class="card-body">
                                        ...
                                        <form class="row g-3" action="{{ url('gambar_kerja/store_doc') }}"
                                ...
                                <table class="table" id="table-2">
                                    ...
                                    <tbody>
                                        @foreach ($data as $item)
                                            <tr>
                                                <td><a target="_blank"
                                                        href="{{ url('dokumen/gambar_kerja/' . $item->nama_file) }}">{{ $item->nama_file ?? '-' }}</a>
                                                </td>
                            ...
                            <div class="tab-pane fade" id="contact-justified" role="tabpanel" aria-labelledby="contact-tab">
                                <h5 class="card-title">Uraian Gambar Kerja</h5>
                                <div class="card mt-3">
                                    <div class="card-body">
                                        <h5 class="card-title">Dokumen Proses <button type="button" class="btn btn-primary"
                                            onclick="document.getElementById('tambah_uraian_gambar_kerja').style.display = 'block'">
                                            <i class="bi bi-plus"></i> Tambah
                                        </button></h5>
                                        <div id="tambah_uraian_gambar_kerja" style="display: none">
                                            <form action="{{ url('gambar_kerja/uraian_gambar_kerja_store') }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5 class="card-title" id="staticBackdropLabel">Tambah Data</h5>
                                                    ...
                                                    <div class="card-body row">
                                                        <div class="col-6 mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="no_uraian_gambar_kerja" name="no_uraian_gambar_kerja" required>
                                                        </div>
                                                        <div class="col-6 mb-3">
                                                            <label for="staticEmail" class="form-label">Judul Gambar Kerja</label>
                                                            <input type="text" class="form-control" id="judul_gambar_kerja" name="judul_gambar_kerja" required>
                                                        </div>
                                                        <div class="col-6 mb-3">
                                                        ...
                                                        <div class="col-6 mb-3">
                                                            <label for="staticEmail" class="form-label">Status Gambar</label>
                                                    ...
                                                    <div class="card-footer">
                                                        <button type="button" class="btn btn-info" onclick="document.getElementById('tambah_uraian_gambar_kerja').style.display = 'none'">Hide</button>
                                                        <button type="reset" class="btn btn-secondary">Reset</button>
                                                        <button type="submit" class="btn btn-primary">Simpan</button>
                                                    </div>
                                                </div>
                                        ...
                                        <div id="editUraianGambarKerja" style="display: none">
                                            <form action="{{ url('gambar_kerja/uraian_gambar_kerja_update') }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5 class="card-title" id="staticBackdropLabel">Ubah Data</h5>
                                                    </div>
                                                    <div class="card-body row" id="tampilUraianGambarKerja">
                                                        
                                                    </div>
                                                    <div class="card-footer">
                                                        <button type="button" class="btn btn-info" onclick="document.getElementById('editUraianGambarKerja').style.display = 'none'">Hide</button>
                                                        <button type="submit" class="btn btn-primary">Simpan</button>
                                                    </div>
                                                </div>
                                            </form>
                                ...
                                <table class="table" id="table-2">
                                    ...
                                    <tbody>
                                        @foreach ($uraian_gambar_kerja as $item)
                                            <tr>
                                                <td>{{ $item->no_uraian_gambar_kerja }}</td>
                                                <td>{{ $item->judul_gambar_kerja }}</td>
                                                <td>{{ $item->revisi_status }}</td>
                                                <td>{{ $item->status_uraian_gambar_kerja }}</td>
                                                <td>{{ $item->keterangan }}</td>
                                                <td>
                                                    <a onclick="return edit_uraian_gambar_kerja({{ $item->uraian_gambar_kerja_id }})"
                                                        class="btn text-white btn-warning"><i class="bi bi-pen"></i></a>
                                                    <a onclick="return confirm('Apakah anda yakin ini akan di hapus?')"
                                                        href="{{ url('gambar_kerja/delete_doc/' . Crypt::encrypt($item->uraian_gambar_kerja_id)) }}"
                                                        class="btn text-white btn-danger"><i class="bi bi-trash"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
...
@section('scripts')
    <script>
        ...
        function edit(id) {
            $.ajax({
                type: 'get',
                url: "{{ url('gambar_kerja/dokumen_proses_edit') }}/" + id,
                // data:{'id':id}, 
        ...
        function edit_uraian_gambar_kerja(id) {
            $.ajax({
                type: 'get',
                url: "{{ url('gambar_kerja/uraian_gambar_kerja_edit') }}/" + id,
                // data:{'id':id}, 
                success: function(tampil) {
                    document.getElementById('editUraianGambarKerja').style.display = 'block';
                    $('#tampilUraianGambarKerja').html(tampil);
                }
            })
        }
        function tambah(id) {
