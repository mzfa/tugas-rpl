...
@section('content')
    ...
    <div class="modal fade" id="basicModal" tabindex="-1">
        <div class="modal-dialog">
            <form action="{{ url('progres/store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="minggu_ke" name="minggu_ke" required>
                        </div>
                        <div class="mb-3">
    ...
    <div class="modal fade" id="editModal" tabindex="-1">
        <div class="modal-dialog">
            <form action="{{ url('progres/update') }}" method="post">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
