                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content pt-2" id="myTabjustifiedContent">
                            <div class="tab-pane fade show active" id="home-justified" role="tabpanel"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">Notulen <button type="button" class="btn btn-primary"
                                        ...
                                        <div id="tambah_dokumen_proses" style="display: none">
                                            <form action="{{ url('notulen/dokumen_proses_store') }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="card">
                                        ...
                                        <div id="editDokumenProses" style="display: none">
                                            <form action="{{ url('notulen/dokumen_proses_update') }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="card">
                                                    <div class="card-header">
                                            ...
                                            <tbody>
                                                @foreach ($agenda as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->username }}</td>
                                                        <td>
                                                            <a onclick="return edit({{ $item->daftar_hadir_id }})"
                                                                class="btn text-white btn-warning"><i class="bi bi-pen"></i></a>
                                                            <a onclick="return confirm('Apakah anda yakin ini akan di hapus?')" href="{{ url('notulen/delete_proses_store/' . Crypt::encrypt($item->daftar_hadir_id)) }}" class="btn text-white btn-danger"><i class="bi bi-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                            ...
                            <div class="tab-pane fade" id="profile-justified" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="card mt-3">
                                    <div class="card-body">
                                        ...
                                        <form class="row g-3" action="{{ url('notulen/store_doc') }}"
                                ...
                                <table class="table" id="table-2">
                                    ...
                                    <tbody>
                                        @foreach ($data as $item)
                                            <tr>
                                                <td><a target="_blank"
                                                        href="{{ url('dokumen/notulen/' . $item->nama_file) }}">{{ $item->nama_file ?? '-' }}</a>
                                                </td>
                                                ...
                                                <td>
                                                    <a onclick="return confirm('Apakah anda yakin ini akan di hapus?')"
                                                        href="{{ url('notulen/delete_doc/' . Crypt::encrypt($item->dokumen_id)) }}"
...
@section('scripts')
    <script>
        ...
        function edit(id) {
            $.ajax({
                type: 'get',
                url: "{{ url('notulen/dokumen_proses_edit') }}/" + id,
                // data:{'id':id}, 
