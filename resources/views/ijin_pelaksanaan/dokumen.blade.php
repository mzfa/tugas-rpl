                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs d-flex" id="myTabjustified" role="tablist">
                            ...
                            <li class="nav-item flex-fill" role="presentation">
                                <button class="nav-link w-100" id="profile-tab" data-bs-toggle="tab"
                                    ...
                                    aria-controls="profile" aria-selected="false" tabindex="-1"><h2>File IPL</h2></button>
                            </li>
                            <li class="nav-item flex-fill" role="presentation">
                                <button class="nav-link w-100" id="contact-tab" data-bs-toggle="tab"
                                    data-bs-target="#contact-justified" type="button" role="tab"
                                    aria-controls="contact" aria-selected="false" tabindex="-1"><h2>Referensi Dok</h2></button>
                            </li>
                        </ul>
                        <div class="tab-content pt-2" id="myTabjustifiedContent">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="tambah_dokumen_proses" style="display: none">
                                            <form action="{{ url('ijin_pelaksanaan/dokumen_proses_store') }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="card">
                                        ...
                                        <div id="editDokumenProses" style="display: none">
                                            <form action="{{ url('ijin_pelaksanaan/dokumen_proses_update') }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="card">
                                                    <div class="card-header">
                                            ...
                                            <tbody>
                                                @foreach ($data_dokumen_proses as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->username }}</td>
                                                        <td>
                                                            <a onclick="return edit({{ $item->dokumen_proses_ijin_pelaksanaan_id }})"
                                                                class="btn text-white btn-warning"><i class="bi bi-pen"></i></a>
                                                            <a onclick="return confirm('Apakah anda yakin ini akan di hapus?')" href="{{ url('ijin_pelaksanaan/delete_proses_store/' . Crypt::encrypt($item->dokumen_proses_ijin_pelaksanaan_id)) }}" class="btn text-white btn-danger"><i class="bi bi-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                            ...
                            <div class="tab-pane fade" id="profile-justified" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="card mt-3">
                                    <div class="card-body">
                                        ...
                                        <form class="row g-3" action="{{ url('ijin_pelaksanaan/store_doc') }}"
                                ...
                                <table class="table" id="table-2">
                                    ...
                                    <tbody>
                                        @foreach ($data as $item)
                                            <tr>
                                                <td><a target="_blank"
                                                        href="{{ url('dokumen/ijin_pelaksanaan/' . $item->nama_file) }}">{{ $item->nama_file ?? '-' }}</a>
                                                </td>
                                                ...
                                                <td>
                                                    <a onclick="return confirm('Apakah anda yakin ini akan di hapus?')"
                                                        href="{{ url('ijin_pelaksanaan/delete_doc/' . Crypt::encrypt($item->dokumen_id)) }}"
                            ...
                            <div class="tab-pane fade" id="contact-justified" role="tabpanel" aria-labelledby="contact-tab">
                                <h5 class="card-title">Referensi Dok</h5>
                                <div class="card mt-3">
                                    <div class="card-body">
                                        <h5 class="card-title">Tambah Dokumen</h5>
                                        <form class="row g-3" action="{{ url('ijin_pelaksanaan/store_doc') }}"
...
@section('scripts')
    <script>
        ...
        function edit(id) {
            $.ajax({
                type: 'get',
                url: "{{ url('ijin_pelaksanaan/dokumen_proses_edit') }}/" + id,
                // data:{'id':id}, 
