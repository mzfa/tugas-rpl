                        ...
                        <ul class="nav nav-tabs d-flex" id="myTabjustified" role="tablist">
                            <li class="nav-item flex-fill" role="presentation">
                                <button class="nav-link w-100 active" id="home-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="true"><h2>Dokumen Approval</h2></button>
                            </li>
                            <li class="nav-item flex-fill" role="presentation">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="tambah_dokumen_proses" style="display: none">
                                            <form action="{{ url('material_approval/dokumen_proses_store') }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="card">
                                        ...
                                        <div id="editDokumenProses" style="display: none">
                                            <form action="{{ url('material_approval/dokumen_proses_update') }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="card">
                                                    <div class="card-header">
                                                ...
                                                @foreach ($data_dokumen_proses as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a onclick="return confirm('Apakah anda yakin ini akan di hapus?')" href="{{ url('material_approval/delete_proses_store/' . Crypt::encrypt($item->dokumen_proses_id)) }}" class="btn text-white btn-danger"><i class="bi bi-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                            ...
                            <div class="tab-pane fade" id="profile-justified" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="card mt-3">
                                    <div class="card-body">
                                        ...
                                        <form class="row g-3" action="{{ url('material_approval/store_doc') }}"
                                ...
                                <div id="editDokumenCommand" style="display: none">
                                    <form action="{{ url('material_approval/dokumen_proses_update') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="card">
                                            <div class="card-header">
                                            ...
                                            <div class="card-body row" id="tampiEditlDokumenCommand">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a onclick="return confirm('Apakah anda yakin ini akan di hapus?')"
                                                        href="{{ url('material_approval/delete_doc/' . Crypt::encrypt($item->dokumen_id)) }}"
...
@section('scripts')
    <script>
        ...
        function edit(id) {
            $.ajax({
                type: 'get',
                url: "{{ url('material_approval/dokumen_proses_edit') }}/" + id,
                // data:{'id':id}, 
        ...
        function editFile(id) {
            $.ajax({
                ...
                // data:{'id':id}, 
                success: function(tampil) {
                    document.getElementById('editDokumenCommand').style.display = 'block';
                    $('#tampiEditlDokumenCommand').html(tampil);
                }
            })
        }
        function tambah(id) {
