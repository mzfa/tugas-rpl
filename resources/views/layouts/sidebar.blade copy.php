        ...
        @isset($sidebar)
                @foreach($sidebar as $item)
                    @if(empty($item['submenu'][0]))
                        <li>
                            <a class="nav-link" ><i class=""></i> <span></span></a>
                            <li class="nav-item">
                                <a class="nav-link " href="@if(Route::has($item['url_menu'])) {{ route($item['url_menu']) }} @endif">
                    ...
                    @else
                        <li class="nav-item">
                            <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                                <i class="bi bi-menu-button-wide"></i><span>{{ $item['nama_menu'] }}</span><i class="{{ $item['icon_menu'] }} ms-auto"></i>
                            </a>
